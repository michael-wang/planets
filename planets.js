...
var RANKS = [];
var RANKS[MASS]          = [PLUTO, MERCURY, MARS, VENUS, EARTH, URANUS, NEPTUNE, SATURN, JUPITER];
var RANKS[DIAMETER]      = [PLUTO, MERCURY, MARS, VENUS, EARTH, NEPTUNE, URANUS, SATURN, JUPITER];
var RANKS[GRAVITY]       = [PLUTO, MARS, MERCURY, URANUS, VENUS, SATURN, EARTH, NEPTUNE, JUPITER];
var RANKS[LEN_OF_DAY]    = [JUPITER, SATURN, NEPTUNE, URANUS, EARTH, MARS, PLUTO, VENUS, MERCURY];
var RANKS[DIST_FROM_SUN] = [MERCURY, VENUS, EARTH, MARS, JUPITER, SATURN, URANUS, NEPTUNE, PLUTO];
var RANKS[ORB_PERIOD]    = [MERCURY, VENUS, EARTH, MARS, JUPITER, SATURN, URANUS, NEPTUNE, PLUTO];
var RANKS[NUM_OF_MOON]   = [MERCURY, VENUS, EARTH, MARS, PLUTO, NEPTUNE, URANUS, SATURN, JUPITER];
